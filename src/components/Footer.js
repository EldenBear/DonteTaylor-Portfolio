  ...
  return (
    ...
    <div id='footer'>
        ...
        <img src='../../github (1).png' alt='github' className='logo'>
          ...
          <a href='https://stackoverflow.com/users/22206512/donte-taylor' className='footer-image-container'>
            <img src='../../9567026_stack_overflow_development_icon.png' alt='Stack Overflow' className='logo'>
            </img>
          </a>
    </div>
    </footer>
